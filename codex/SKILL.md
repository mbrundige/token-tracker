...
```bash
~/.codex/skills/token-tracker/scripts/report-token-usage.js
```
...
```bash
~/.codex/skills/token-tracker/scripts/set-token-context.js --workspace "$PWD" --feature "<name>"
```

Or to clear:

```bash
~/.codex/skills/token-tracker/scripts/set-token-context.js --workspace "$PWD" --clear-feature
```
...
```bash
~/.codex/skills/token-tracker/scripts/set-token-context.js --workspace "$PWD" --feature "maintenance"
```
